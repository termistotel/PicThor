...
class DBlink(object):
	...
	def __init__(self, loc):
		...
		self.loc = loc
		self.filterkerneltable = "filterkernels"
		self.openFilterTable()

		self.execute = self.cur.execute

	"""Thanks SoulNibbler for functions adapt_array, convert_array and initialize 
	http://stackoverflow.com/a/31312102/190597 (SoulNibbler)"""
...
link = DBlink('PicThor.db')
#link.reset()
print(link.groupList())